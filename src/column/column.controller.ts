...
export class ColumnController {
  ...
  @ApiResponse({ status: 200, description: 'List of columns for the specified board' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  async findColumnsByBoard(
  ...
  @ApiResponse({ status: 200, description: 'The updated column', type: UpdateColumnDto })
  @ApiResponse({ status: 400, description: 'Invalid data' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  async updateColumn(
